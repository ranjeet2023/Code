                    ...
                    <div class="card-wrapper">
                        <div class="align-left">
                            <p class="card-text mbr-fonts-style display-4" style="line-height:20px">
                                <b><h2>What Does a Front-End Developer Do? </h2></b><br>A front-end developer builds the front-end portion of websites
                                and web applications—the part users see and interact with.
                                A front-end developer creates websites and applications using web languages such as HTML,
                                 CSS, and JavaScript that allow users to access and interact with the site or app.
                            ...
                            <p class="card-text mbr-fonts-style display-4" style="line-height:20px">
                            <b><h2>Front-end developer job description:</h2> </b> <br>If someone wanted to build a website,
                             they might hire a front-end developer to create the site's layout. The front-end developer determines
                             where to place images, what the navigation should look like, and how to present the site. Much of their
                              work involves ensuring the appearance and layout of the
                             site or application is easy to navigate and intuitive for the user.
                            </p><hr>
                            <p class="card-text mbr-fonts-style display-4" style="line-height:20px">
                            <b><h2>Average salary for front-end developers: </h2> </b><br>As of February 2023, Glassdoor
                            reports an average yearly pay of $84,235 for front-end developers in the US. This figure
                            includes an average annual salary of $78,516 and a reported additional pay of $5,719.
                            Additional pay insights may include profit-sharing, commissions, or bonuses. Factors like education
                             level, experience, and certifications may affect salary range.
                            </p><hr>
                            <p class="card-text mbr-fonts-style display-4" style="line-height:20px">
                            <b><h2>How to become a front-end developer: </h2></b><br> A career as a front-end web developer can
                            flex your creativity and problem-solving skills. As a field that is constantly evolving to incorporate
                            ...
                            <h5><b>These three languages are essential to anyone who wants to work in front-end development.</b></h5><br><br>
                            <ul>
                            ...
                            <div id="accordion ">
                              <h3 class="text-center">Course Fees ₹ 8000 (3 Month Course)</h3>
