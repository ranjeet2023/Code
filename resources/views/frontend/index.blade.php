        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-12 col-lg-5 image-wrapper">
                    <img class="w-100" src="{{ asset('assets/image/features3.jpg') }}" alt="Mobirise Website Builder" />
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="text-wrapper align-left md-pb">
                        ...
                        <h1 class="mbr-section-title mbr-fonts-style mb-4 display-2">
                            <strong>Why our&nbsp;<a href="" class="text-secondary">Framework?</a></strong>
                        </h1>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="text-wrapper align-left md-pb">
                        ...
                        <h1 class="mbr-section-title mbr-fonts-style mb-4 display-2">
                            <strong>Save time with our&nbsp;<a href=""
                                    class="text-secondary">Framework?</a></strong>
                        </h1>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-box align-left">
                            <h4 class="card-title align-left mbr-black mbr-fonts-style pb-2 display-2">
                                <strong>15min</strong>
                            </h4>
                            <p class="card-text mbr-fonts-style display-4">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-box align-left">
                            ...
                            <p class="card-text mbr-fonts-style display-4">
                                Mauris leo imperdiet commodo felis lacinia urna .
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-box align-left">
                            ...
                            <p class="card-text mbr-fonts-style display-4">
                                Nam lacinia nisl sed accumsan hendrerit ullamcorper.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row wrap justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="image">
                        <img src="{{ asset('assets/image/team1.jpg') }}" alt="" title="" />
                        <div class="text__block text-white">
                            <p class="text__title mbr-bold mbr-fonts-style display-7">
                                James Butler
                            </p>
                            <p class="text__descr mbr-fonts-style display-4">Developer</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="image">
                        <img src="{{ asset('assets/image/team2.jpg') }}" alt="" title="" />
                        <div class="text__block text-white">
                            <p class="text__title mbr-bold mbr-fonts-style display-7">
                                Lucy Gray
                            </p>
                            <p class="text__descr mbr-fonts-style display-4">Designer</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="image">
                        <img src="{{ asset('assets/image/team3.jpg') }}" alt="" title="" />
                        <div class="text__block text-white">
                            <p class="text__title mbr-bold mbr-fonts-style display-7">
                                Nik White
                            </p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="image">
                        <img src="{{ asset('assets/image/team4.jpg') }}" alt="" title="" />
                        <div class="text__block text-white">
                            <p class="text__title mbr-bold mbr-fonts-style display-7">
                                Krysten Black
                            </p>
        ...
        <div class="images-container container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-md-3 card">
                    <img src="{{ asset('assets/image/1.png') }}" alt="Mobirise Website Builder" />
                </div>
                <div class="col-md-3 card">
                    <img src="{{ asset('assets/image/2.png') }}" alt="Mobirise Website Builder" />
                </div>
                <div class="col-md-3 card">
                    <img src="{{ asset('assets/image/3.png') }}" alt="Mobirise Website Builder" />
                </div>
                <div class="col-md-3 card">
        ...
        <div class="images-container container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h2 class="section-title text-center text-dark px-3" style="color:black;text-decoration:underline;">Contact Us</h2>
                </div>
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <iframe class="position-relative rounded w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3580.7726238008718!2d81.8202397!3d26.1715336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399af5aaec6cda0d%3A0xde1e38171848ea67!2sSHUBH%20IT%20SOLUTION!5e0!3m2!1sen!2sin!4v1686972616065!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
