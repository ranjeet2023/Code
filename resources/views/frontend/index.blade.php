...
@extends('frontend.layouts.main')
 @section('content')
  ...
  <section data-bs-version="5.1" class="menu menu1 cid-tlVfrwbwzd" once="menu" id="menu01-0">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
              ...
              <li class="nav-item">
                <a class="nav-link link text-secondary show display-4" href="/" aria-expanded="true">Features</a>
              </li>
              <li class="nav-item">
                <a class="nav-link link text-secondary display-4" href="/">About</a>
              </li>
              <li class="nav-item">
            ...
            <div class="navbar-buttons mbr-section-btn">
              ...
              <a class="btn btn-primary display-4" href="/">Read More</a>
            </div>
          </div>
        </div>
      </nav>
    ...
    <section
      data-bs-version="5.1"
      class="features1 cid-tlVYX2lz1A"
      id="features01-d"
    >
      <div class="container">
        <div class="row"></div>
    ...
    <section
      data-bs-version="5.1"
      class="features5 cid-tlVYoWlm5Q"
      id="features05-3"
    >
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-12 col-lg">
            <div class="text-wrapper align-left md-pb">
              ...
              <div class="link-wrapper">
                <div class="link mb-2">
                  <span
                    class="mbr-linkiconfont mobi-mbri-right mobi-mbri"
                  ></span>
    ...
    <section
      data-bs-version="5.1"
      class="features4 cid-tlVYmXxmF5"
      id="features04-2"
    >
      <div class="container">
        <div class="row">
    ...
    <section
      data-bs-version="5.1"
      class="features6 cid-tlVYUtaSS3"
      id="features06-b"
    >
      <div class="container">
        <div class="row"></div>
                ...
                <div class="card-wrapper">
                  <div class="card-box align-left">
                    ...
                    <div class="iconfont-wrapper align-right">
                      <span
                        class="mbr-iconfont mobi-mbri-right mobi-mbri"
                      ></span>
                    </div>
                  </div>
                </div>
    ...
    <section
      data-bs-version="5.1"
      class="features2 cid-tlVYwNE43i"
      id="features02-4"
    >
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card-wrapper">
              <div class="card-box align-left">
                <h4
                  class="card-title align-left mbr-black mbr-fonts-style pb-2 display-2"
                >
                  <strong>15min</strong>
                </h4>
                <p class="card-text mbr-fonts-style display-4">
    ...
    <section data-bs-version="5.1" class="list1 cid-tlVYPsHV3r" id="list01-a">
      <div class="container">
        <div class="row">
          <div class="col-12 pb-5">
            <h3
              class="mbr-section-title mbr-fonts-style align-left mb-0 display-5"
            >
    ...
    >
      <div class="images-container container">
        ...
        <div class="row justify-content-center mt-4">
          ...
          <div class="col-md-3 card">
            <img
              src="{{ asset('assets/image/2.png')}}"
              alt="Mobirise Website Builder"
            />
          </div>
          <div class="col-md-3 card">
            <img
              src="{{ asset('assets/image/3.png')}}"
              alt="Mobirise Website Builder"
            />
          </div>
          <div class="col-md-3 card">
            <img
              src="{{ asset('assets/image/4.png')}}"
              alt="Mobirise Website Builder"
            />
          </div>
          <div class="col-md-3 card">
        ...
        <div class="row justify-content-center">
          <div class="col-12 card col-md-12 col-lg-10">
            <div class="text-wrapper align-left md-pb">
              ...
              <div class="img-wrap">
                <img    src="{{ asset('assets/image/4.png')}}"
                  alt="Mobirise Website Builder"
                />
              </div>
            </div>
